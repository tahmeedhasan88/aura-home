...
import AddListing from "@/app/Components/Buttons/AddListing";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden shadow-[0_0_30px_rgba(16,185,129,0.18)] p-6">
          <div className="flex flex-col lg:flex-row lg:flex-nowrap gap-6 items-start detail-layout">
            ...
            <div className="w-full lg:flex-[0_0_35%] lg:w-auto min-w-0 flex flex-col justify-between gap-8 detail-right px-3">
              <div>
                ...
                <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div className="rounded-3xl bg-white/5 p-4 text-center border border-white/10">
                    ...
                    <p className="mt-2 text-[16px] font-semibold overflow-hidden text-white">{home.status}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between px-5">

                <AddListing home = {home}></AddListing>
